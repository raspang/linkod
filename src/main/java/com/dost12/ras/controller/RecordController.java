...
public class RecordController {
	...
	public String listParticipants(ModelMap model) {
		List<Participant> voters = voterService.findAllVoters();
	...
	public String markAttended(@PathVariable String id, ModelMap model,HttpServletRequest request) {
		...
		Participant voter = voterService.findById(Long.parseLong(id));
	...
	public String pdfReportRegistrationForm(HttpServletRequest request, HttpServletResponse response)
		...
		for(Participant participant : voterService.findAllVoters(generateStartNo, generateEndNo)) {
	...
	public String deletePerson(@PathVariable String id) {
		Participant code = voterService.findById(Long.parseLong(id));
