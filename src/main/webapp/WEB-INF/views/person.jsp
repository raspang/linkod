...
<body>
	...
	<div class="container-fluid">
		...
		<form:form method="POST" modelAttribute="voter" class="form-horizontal">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="attended">Attending*</label>
					<div class="col-md-7">
						<form:input type="text" path="attended" id="attended" class="form-control input-sm" placeholder="Dec. 3,"/>
						<div class="has-error">
							<form:errors path="attended" class="help-inline" />
						</div>
					</div>
				</div>
			</div>
